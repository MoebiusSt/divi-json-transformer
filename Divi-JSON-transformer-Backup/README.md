# DIVI JSON Transformer v2.0.5

Transform DIVI JSON exports. Split long DIVI text modules which contain HTML text with headings or lists into several text modules or rows. A free, open-source web application tool that works entirely in your browser. No dependencies.
...
- Coded by Claude Sonnet 4.5 with 'app builder skill', Nov.2025
